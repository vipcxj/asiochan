...
namespace asiochan::detail
{
    ...
    {
      public:
        explicit channel_op_result_base(const channel_type<T> auto& channel)
          : shared_state_{channel.shared_state_ptr().get()} { }
        ...
        {
            return channel.shared_state_ptr().get() == shared_state_;
        }
